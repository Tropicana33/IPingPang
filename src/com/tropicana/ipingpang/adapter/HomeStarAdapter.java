...
public class HomeStarAdapter extends BaseAdapter {
	...
	public HomeStarAdapter(Context context,ArrayList<StarsInfo> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		tv.setText(homeStarInfos.get(position).player);
		utils.display(iv, GlobalContants.SERVER_URL+homeStarInfos.get(position).image);
