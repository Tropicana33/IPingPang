...
public class RefreshExpendListView extends ExpandableListView implements 
OnScrollListener{
	...
	public RefreshExpendListView(Context context) {
		super(context);
		initHeaderView();
	}

	public RefreshExpendListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initHeaderView();
	}

	public RefreshExpendListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initHeaderView();
	}
